...
class N8nWebhookTester:
    ...
    def __init__(self, base_url: str = "http://localhost:8000", 
                 n8n_url: str = "http://localhost:5678/webhook/reco-nutrition",
...
Exemples:
  ...
  python test_n8n_webhook.py --test-n8n
    ...
    parser.add_argument(
        '--n8n-url',
        default='http://localhost:5678/webhook/reco-nutrition',
        help='URL du webhook N8N (défaut: http://localhost:5678/webhook/reco-nutrition)'
    )
    parser.add_argument(
        '--token',
